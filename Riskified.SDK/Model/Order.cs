// // -----------------------------------------------------------------------
// // <copyright from="2019" to="2019" file="Order.cs" company="Lindell Technologies">
...
namespace Riskified.SDK.Model
{
    public class Order : OrderBase
    {
        ...
        /// <param name="cartToken">
        ///     Unique identifier for a particular cart or session that is attached to a particular order. The
        ///     same ID should be passed in the Beacon JS (optional)
        /// </param>
        ...
        /// <param name="noChargeDetails">
        ///     No charge sums - including all payments made for this order in gift cards, cash, checks or
        ///     other non chargeback-able payment methods
        /// </param>
        /// <param name="decisionDetails"></param>
        /// <param name="clientDetails">Technical information regarding the customer's browsing session</param>
        /// <param name="chargeFreePaymentDetails">
        ///     Payment sums made using non-chargeback-able methods and should be omitted from
        ///     the Chargeback guarantee sum and Riskified fee
        /// </param>
        ...
        /// <param name="groupFounderOrderId"></param>
        /// <param name="referringSite"></param>
