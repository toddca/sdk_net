// // -----------------------------------------------------------------------
// // <copyright from="2019" to="2019" file="LineItem.cs" company="Lindell Technologies">
...
namespace Riskified.SDK.Model.OrderElements
{
    public class LineItem : IJsonSerializable
    {
        ...
        /// <param name="price">
        ///     The product price in the currency matching the one used in the whole order and set in the
        ///     "Currency" field
        /// </param>
        ...
        /// <param name="requiresShipping"></param>
        /// <param name="seller"></param>
        /// <param name="deliveredTo"></param>
        ...
        /// <summary>
        ///     States whether or not the fulfillment requires shipping. This field is important for merchants dealing with digital
        ///     goods.
        /// </summary>
        ...
        /// <summary>
        ///     The delivered to will tell us where is the customer would like to get the product
        /// </summary>
