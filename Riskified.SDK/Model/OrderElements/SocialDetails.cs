// // -----------------------------------------------------------------------
// // <copyright from="2019" to="2019" file="SocialDetails.cs" company="Lindell Technologies">
...
namespace Riskified.SDK.Model.OrderElements
{
    public class SocialDetails : IJsonSerializable
    {
        public SocialDetails(
            string network, string publicUsername, int? communityScore = null, string profilePictureUrl = null, string email = null, string bio = null,
