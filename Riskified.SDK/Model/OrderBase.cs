// // -----------------------------------------------------------------------
// // <copyright from="2019" to="2019" file="OrderBase.cs" company="Lindell Technologies">
...
namespace Riskified.SDK.Model
{
    ...
    {
        protected OrderBase(string merchantOrderId) : base(merchantOrderId)
        {
        }
        ...
        /// <summary>
        ///     The session id that this order was created on, this value should match the session id value that is passed in the
        ///     beacon JavaScript.
        /// </summary>
